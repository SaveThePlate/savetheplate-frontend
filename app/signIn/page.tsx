...
<div className="w-screen h-screen flex justify-center items-center bg-gradient-to-r from-green-400 via-green-300 to-green-200">
  <div className="bg-white shadow-lg rounded-lg p-8 w-3/4 sm:w-2/5 md:w-1/3 lg:w-1/4">
    <div className="flex flex-col items-center space-y-4 mb-6">
      <h1 className="font-bold text-3xl text-green-900">
        {isNewUser ? "Welcome to SaveThePlate! 🥳" : "Welcome back! We've missed you! 🥰"}
      </h1>
      <p className="font-light text-lg text-gray-600 text-center">
        {isNewUser ? "Join us in reducing food waste and saving the planet, one meal at a time." 
    ...
    <p className="mt-8 text-center font-light text-sm text-gray-500">
      {isNewUser ? "Check your inbox to complete your registration and start rescuing meals!" 
