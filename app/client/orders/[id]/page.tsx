        ...
        <section className="space-y-8">
          {loading ? (
            ...
            <div className="bg-red-50 border-2 border-red-200 rounded-2xl p-8 text-center">
              ...
              <p className="text-red-800 text-lg font-semibold mb-2">Error Loading Orders</p>
            ...
            <div className="bg-white rounded-3xl shadow-lg border-2 border-gray-100 p-12 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                Start rescuing food and saving the planet! Browse available offers and place your first order.
              </p>
              <Button
